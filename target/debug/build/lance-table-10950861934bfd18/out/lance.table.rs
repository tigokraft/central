...
impl ::prost::Name for ShardManifest {
    const NAME: &'static str = "ShardManifest";
    const PACKAGE: &'static str = "lance.table";
    fn full_name() -> ::prost::alloc::string::String {
        "lance.table.ShardManifest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/lance.table.ShardManifest".into()
    }
...
impl ::prost::Name for ShardFieldEntry {
    const NAME: &'static str = "ShardFieldEntry";
    const PACKAGE: &'static str = "lance.table";
    fn full_name() -> ::prost::alloc::string::String {
        "lance.table.ShardFieldEntry".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/lance.table.ShardFieldEntry".into()
    }
...
impl ::prost::Name for ShardingSpec {
    const NAME: &'static str = "ShardingSpec";
    const PACKAGE: &'static str = "lance.table";
    fn full_name() -> ::prost::alloc::string::String {
        "lance.table.ShardingSpec".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/lance.table.ShardingSpec".into()
    }
...
impl ::prost::Name for ShardingField {
    const NAME: &'static str = "ShardingField";
    const PACKAGE: &'static str = "lance.table";
    fn full_name() -> ::prost::alloc::string::String {
        "lance.table.ShardingField".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/lance.table.ShardingField".into()
    }
...
pub mod transaction {
    ...
    impl ::prost::Name for UInt32List {
        const NAME: &'static str = "UInt32List";
        const PACKAGE: &'static str = "lance.table";
        fn full_name() -> ::prost::alloc::string::String {
            "lance.table.Transaction.UInt32List".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/lance.table.Transaction.UInt32List".into()
        }
