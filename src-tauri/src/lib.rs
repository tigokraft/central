...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            git_engine::get_branch_diff,
            git_engine::bind_workbench_session,
            git_engine::promote_workbench_session,
            git_engine::discard_workbench_session,
            ...
            workspace_fs::read_worktree_file,
